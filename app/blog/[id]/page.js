                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="postbox__content postbox__content-area mb-55">
                                                            <div className="postbox__meta mb-15">
                                                                ...
                                                                <span>
                                                                    <i className="fal fa-clock" /> Dec 28, 2026
                                                                </span>
                                                                <span>
                                                                    <Link href="#">
                                                ...
                                                <li>
                                                    <div className="postbox__comment-box d-flex">
                                                        ...
                                                        <div className="postbox__comment-text">
                                                            ...
                                                            <p>
                                                                Patient Comments are a collection of comments submitted by viewers in response to <br /> a question posed by a MedicineNet doctor.
                                                            </p>
                                                ...
                                                <li className="children mb-30">
                                                    <div className="postbox__comment-box d-flex">
                                                        ...
                                                        <div className="postbox__comment-text">
                                                            ...
                                                            <p>
                                                                Include anecdotal examples of your experience, or things you took notice of that you <br /> feel others would find useful.
                                                            </p>
                                                            <div className="postbox__comment-reply">
                                                                <Link href="#">
                                                                    <i className="fas fa-reply-all" />
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xxl-12">
                                                        <div className="postbox__comment-btn ">
                                                            <button type="submit" className="tp-color-btn tp-btn banner-animation">
                                                                Post Comment
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="sidebar__post rc__post">
                                                    <div className="rc__post mb-20 d-flex align-items-center">
                                                        <div className="rc__post-thumb">
                                                            <Link href="/blog-details">
                                                                <img src="/assets/img/blog/sidebar/blog-sm-1.jpg" alt="blog-sidebar" />
                                                            </Link>
                                                        </div>
