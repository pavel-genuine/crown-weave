...
export default function HeaderMobSticky({ scroll, isMobileMenu, handleMobileMenu, isCartSidebar, handleCartSidebar }) {
    return (
        <>
            <div style={{ backgroundImage: scroll ? "" : "url('assets/img/bg-pattern.png')", }} id="header-mob-sticky" className={`tp-md-lg-header d-md-none pt-20 pb-20  ${scroll ? "header-sticky" : ""}`}>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-6">
                            <div className="logo text-center">
                                <Link href="/"><img style={{ width: '70%' }} src="/assets/img/logo/logo.png" alt="logo" /></Link>
                            </div>
                        </div>
                        <div className="col-3">
