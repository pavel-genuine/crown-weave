                            ...
                            <div className="tpbanneritems p-relative">
                                <div className="tpbanneritem__thumb mb-20">
                                    ...
                                    <div className="tpbanneritem__content">
                                        <p>Furniture</p>
                                        <h5 className="tpbanneritem__title mb-60"><Link href="/-2">New Modern  Stylist <br /> Crafts</Link></h5>
                                        <div className="tpbanneritem__btn">
                                            <Link className="tp-btn green-btn banner-animation" href="/-2">Shop Now <i className="fal fa-long-arrow-right" /></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        <div className="tpbanneritem__thumb banner-animation p-relative">
                                            ...
                                            <div className="tpbanneritem__text">
                                                <h5 className="tpbanneritem__text-title"><Link href="/-2">Lamp <br /> Collections</Link></h5>
                                            </div>
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        <div className="tpbanneritem__thumb banner-animation p-relative">
                                            ...
                                            <div className="tpbanneritem__text">
                                                <h5 className="tpbanneritem__text-title"><Link href="/">Minimal Chair</Link></h5>
